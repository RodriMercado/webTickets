            ...
            <div class="col-md-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" placeholder="Ingresar nombre" name="nombre" class="form-control" id="nombre" aria-describedby="nombre">
                    </div>
                    <div class="mb-3">
                    ...
                    <br>
                    <div class="text-center"><a href="<?= site_url('usuarios/login/') ?>">Ya tienes cuenta? Inicia Sesion </a></div>
                </div>
                </div>
            </div>
